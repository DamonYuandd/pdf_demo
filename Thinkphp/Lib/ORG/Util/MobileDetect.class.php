 ...
 */
class MobileDetect extends Think
{
    ...
    protected $phoneDevices = array(
            ...
            'Palm' => 'PalmSource|Palm', // avantgo|blazer|elaine|hiptop|plucker|xiino
                                                  // ; @todo - complete the
                                                  // regex.
            'Vertu' => 'Vertu|Vertu.*Ltd|Vertu.*Ascent|Vertu.*Ayxta|Vertu.*Constellation(F|Quest)?|Vertu.*Monika|Vertu.*Signature', // Just
                                                                                                                                            // for
                                                                                                                                            // fun
                                                                                                                                            // ;)
    ...
    protected $tabletDevices = array(
            ...
            'iPad' => 'iPad|iPad.*Mobile', // @todo: check for
                                                        // mobile friendly
                                                        // emails topic.
    ...
    function __construct ()
    {
        ...
        $this->detectionRules = array_merge($this->phoneDevices, 
                $this->tabletDevices, $this->operatingSystems, $this->userAgents);
        ...
        if (isset($_SERVER['HTTP_X_WAP_PROFILE']) ||
                 ...
                 isset($_SERVER['HTTP_X_OPERAMINI_PHONE_UA']) || // Reported by
                                                                // Nokia devices
                                                                // (eg. C3)
                                                                             ...
                                                                             // HTC
        {
            $this->isMobile = true;
                 ...
                 (strpos($this->accept, 'text/vnd.wap.wml') !== false ||
                 strpos($this->accept, 'application/vnd.wap.xhtml+xml') !== false)) {
            $this->isMobile = true;
        } else {
            $this->_detect();
        }
