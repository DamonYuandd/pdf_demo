...
// +----------------------------------------------------------------------
// $Id: Widget.class.php 2207 2011-11-30 13:17:26Z liu21st $
 ...
 * @subpackage  Util
 * @author liu21st <liu21st@gmail.com>
 * @version  $Id: Widget.class.php 2207 2011-11-30 13:17:26Z liu21st $
 +------------------------------------------------------------------------------
 */
abstract class Widget extends Think {
     ...
     * @return string
     +----------------------------------------------------------
     */
    protected function renderFile($templateFile='',$var='',$partInfo = '',$charset='utf-8') {
        ob_start();
        ob_implicit_flush(0);
        if(!file_exists_case($templateFile)){
            ...
            $templateFile = LIB_PATH.'Widget/'.$name.'/'.$partInfo.'/'.$filename.C('TMPL_TEMPLATE_SUFFIX');
            if(!file_exists_case($templateFile))
