...
function ckstyle() { //定义总的风格
    var ck = new Object();
  //  ck.cpath = '../Public/video/assets/'; //风格总路径
  	ck.cpath = window.cpath; //风格总路径
    ck.mylogo = '11logo.swf';
    ck.logo = 'scklogo.png,2,100,10';
    ...
    ck.advmarquee = '{a href="##" target="_blank"}{font color="#FFFFFF" size="12"}##{/font}{/a}';
